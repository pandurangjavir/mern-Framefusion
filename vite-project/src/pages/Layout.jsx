    ...
    <div className="bg-[#18191b] min-h-screen w-full">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4 justify-center items-center relative">
              ...
              <div onClick={() => setShow(!show)} className="cursor-pointer">
                <img
                  src="https://lh3.googleusercontent.com/ogw/AGvuzYakFDgCYwHYZfdW4Ek8U7ipJBkICOLL1_6Qn-oaaw=s64-c-mo"
                  className="w-[45px] h-[45px] rounded-full"
                  alt="profile"
                />
              </div>
              <div
                className={`absolute top-[60px] right-0 w-[250px] bg-[#313030] p-3 border border-gray-700 transition-opacity duration-500 ${
              ...
              >
                ...
                <div className="flex justify-center flex-col items-start">
                  <span className="text-[#e0dddd] font-bold text-md">FrameFusion</span>
                  <span className="text-[#c4c0c0] font-bold text-md">framefusion@gmail.com</span>
                </div>
      ...
      <div className='w-full flex mt-16'>
        <div className='sidebar w-[300px] p-5 h-[calc(100vh-70px)] fixed'>
            ...
            <img className='w-[40px] h-[40px] rounded-full' src="https://lh3.googleusercontent.com/ogw/AGvuzYakFDgCYwHYZfdW4Ek8U7ipJBkICOLL1_6Qn-oaaw=s64-c-mo" alt="image"/>
            <div className='flex justify-center flex-col items-start'>
                <span className='text-[#e0dddd] font-bold text-md'>FrameFusion</span>
